...
<!--            分配角色按钮-->
            <el-tooltip effect="dark" content="分配角色" placement="top">
              <el-button type="warning" icon="el-icon-setting" size="mini"
                         enterable="false" @click="setRole(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
<!--    修改用户的对话框-->
    <el-dialog
      ...
      <el-form :model="editForm" :rules="editFormRules"
               ref="editFormRef" label-width="70px" @close="editDialogClose">
    ...
    return {
      ...
      addFormRules: {
        ...
        password: [
          ...
          { min: 8, max: 16, message: '密码的长度在 8 到 16 个字符之间', trigger: 'blur' }
        ],
        email: [
          { required: true, message: '请输入邮箱', trigger: 'blur' },
          { validator: checkEmail, triger: 'blur' },
          { min: 3, max: 18, message: '邮箱的长度在 3 到 18 个字符之间', trigger: 'blur' }
        ],
        mobile: [
          { required: true, message: '请输入手机号码', trigger: 'blur' },
          { validator: checkMobile, triger: 'blur' },
          { min: 6, max: 18, message: '手机号码的长度在 3 到 18 个字符之间', trigger: 'blur' }
        ]
      },
      // 控制修改用户信息对话框的显示与隐藏
